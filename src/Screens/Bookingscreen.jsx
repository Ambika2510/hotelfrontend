...
const Bookingscreen = () => {
  ...
  return (
    ...
    <div className='m-5  flex justify-center '>
        <div className="flex flex-col items-center bg-white border border-gray-200  shadow md:flex-row md:max-w-6xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
