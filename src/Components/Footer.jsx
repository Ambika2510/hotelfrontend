...
<footer className=" shadow w-full bg-zinc-600 dark:bg-gray-900">
    <div className="w-full container mx-auto p-4 md:px-6 md:py-8">
        ...
        <div className="flex justify-center text-xl font-medium text-slate-100">© 2023 <a href="/home" className="hover:underline">Hotel Booking</a>. Owner : AMBIKA KUMAR.</div>
    </div>
</footer>
